...
extension STTextView: NSTextInputClient
{
  ...
  @objc public func attributedSubstring(forProposedRange range: NSRange, actualRange _: NSRangePointer?) -> NSAttributedString?
  {
  ...
  @objc public func firstRect(forCharacterRange range: NSRange, actualRange _: NSRangePointer?) -> NSRect
  {
